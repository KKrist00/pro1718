...
public class Principal {
	...
	public static void main(String[] args) {
		...
		Estudiante estudiante2 = new Estudiante(111, "44556674T", "Javier", 'M', LocalDate.now(), 187, estAnonimo,null);
		
		Estudiante estudiante3 = new Estudiante(111, "44556672X", "Marcos", 'M', LocalDate.now(), 187, estAnonimo, null);
		...
		int listaEdad = practicas.calculaEdad(fechaNacimiento);
