...
public class Principal {
	...
	//	practicas.recorrerMatrizIrregularPorColumnas(matriz);
		...
		String[] Alumnos={
				"54091958y","4578452","43663533-"};
		
				boolean Alumno = metodos.metodo1(Alumnos);
		
		// ejercicio 2
				
				String[] VehiculosCadena={"2@CITROEN@C4@16.25","t@RENAULT@CLIO@5.50","7@TOYOTA@AURIS@16.X",
						"5@VOLKWAGEN@TUAREG@18.50"};
						
						Vehiculo[] Vehiculos= metodos.metodo2(VehiculosCadena);
		...
		ArrayList <Integer>numero = practicas.convierteCadenasANumeros(lista);
